...
class User(db.Model, UserMixin):
    ...
    calendar_token = db.Column(db.String(64), unique=True, index=True, nullable=True)
...
class UserProfile(db.Model):
    ...
    weekly_focus_sports = db.Column(db.String(200))   # comma-separated keys for weekly goals UI
    ...
    target_time_text = db.Column(db.String(80))       # e.g. "1:45:00 half marathon"
